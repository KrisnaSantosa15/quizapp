...
public class Form_Users extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        userTable = new com.raven.swing.PanelBorder();
    ...
    private void btnUpdateAccActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateAccActionPerformed
        ...
        if (inputUname.getText().isEmpty()) {
            ...
            String pass = inputPass.getText();
            String role = (String) inputRole.getSelectedItem();
            String accId = inputSearch.getText(); // Retrieve ID from inputSearch

            // Check if username already exists for other users
            boolean usernameExists = checkUsernameExists(uname, accId);

            if (usernameExists) {
                JOptionPane.showMessageDialog(null, "Username already exists for another user! Please choose a different username.");
            } else {
                ...
                if (response == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        pst.setString(2, pass);
                        pst.setString(3, role);
                        pst.setString(4, accId); // Set ID for WHERE clause
                        ...
                        if (k == 1) {
                            ...
                            inputBersih();
                            btnClearFindActionPerformed(evt);
                            loadAllData(); // Reload data after update
                        } else {
                            JOptionPane.showMessageDialog(null, "Error Occurred, Item Not Updated! or Account Not Found!");
                        }
                    } catch (Exception e) {
                        JOptionPane.showMessageDialog(null, e);
                    }
    ...
    private com.raven.swing.PanelBorder userTable;
