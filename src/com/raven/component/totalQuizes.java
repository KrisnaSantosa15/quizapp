 ...
 * @author rifdahhr
 */
public class totalQuizes extends javax.swing.JPanel {
    ...
    public totalQuizes() {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery("SELECT COUNT(*) AS total FROM quizes");
            if (rs.next()) {
                    lbValues.setText(rs.getString("total"));
                }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/icons8-book-50.png"))); // NOI18N
        ...
        lbDescription.setText("Total Quizes");
