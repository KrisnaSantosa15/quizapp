...
public class Banner extends javax.swing.JPanel {
    ...
    public Banner() {
        initComponents();
        setOpaque(false);
        color1 = new Color(28, 181, 224);
        color2 = new Color(0, 0, 70);
    }
    ...
    private void initComponents() {
        ...
        lbTitle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/colors-students-at-graduation-ceremony (1).png"))); // NOI18N

        lbValues.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        lbValues.setForeground(new java.awt.Color(255, 255, 255));
        lbValues.setText("Your students are doing great 60% students");

        lbValues1.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        lbValues1.setForeground(new java.awt.Color(255, 255, 255));
        lbValues1.setText("has completed the test.");
